...
<div class="mt-4 mx-auto max-w-7xl">
    <form action="index.php?build=adddm" method="POST">
        <h1 class="text-[17px] font-medium text-gray-600 p-2">Tên danh mục</h1>
        <input class="border-black border-2 rounded-[20px] w-[600px] pl-[20px]" type="text" name="adddanhmuc" id="adddanhmuc" placeholder="Tên danh mục" >
        <br>
