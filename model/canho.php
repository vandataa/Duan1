<?php
function insert_ch($iddm, $vitri, $niemyet, $hinh, $video, $sophong, $sogiuong, $metvuong, $mota, $trangthai)
{
    $sql = "INSERT INTO `canho`(`iddm`,`vitri`,`niemyet`,`hinh`,`video`,`sophong`,`sogiuong`,`metvuong`,`mota`,`tinhtrang`) value ('$iddm', '$vitri', '$niemyet', '$hinh', '$video', '$sophong', '$sogiuong', '$metvuong', '$mota', '$trangthai')";
    pdo_execute($sql);
}
